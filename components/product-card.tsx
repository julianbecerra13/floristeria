...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Card className="group relative overflow-hidden py-0 gap-0 transition-all hover:shadow-lg">
      {/* Overlay link: cubre toda la card para navegar al detalle */}
      <Link
      ...
      <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-pink-100 to-rose-50">
        ...
        {product.badge && (
          <Badge className="absolute top-3 left-3 bg-pink-600 hover:bg-pink-600 text-white text-xs z-20">
            {product.badge}
          </Badge>
        )}
      </div>
